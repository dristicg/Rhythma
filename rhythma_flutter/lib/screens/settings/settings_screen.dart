        ...
        body: ListView(
          ...
          children: [
            ...
            GlassCard(
              ...
              child: Column(
                children: [
                  Semantics(
                    button: true,
                    hint: 'Double tap to open language selection',
                    child: ListTile(
                      leading: TintedIcon(
                  ...
                  Semantics(
                    button: true,
                    hint: 'Double tap to open theme selection',
                    child: ListTile(
                      leading: TintedIcon(
            ...
            GlassCard(
              ...
              child: Column(
                children: [
                  Semantics(
                    button: true,
                    hint: 'Double tap to open permissions',
                    child: ListTile(
                      leading: TintedIcon(
                  ...
                  Semantics(
                    button: true,
                    hint: 'Double tap to open privacy policy',
                    child: ListTile(
                      leading: TintedIcon(
            ...
            GlassCard(
              ...
              child: Semantics(
                button: true,
                hint: 'Double tap to email support',
                child: ListTile(
            ...
            GlassCard(
              ...
              child: Semantics(
                button: true,
                hint: 'Double tap to open log out confirmation',
                child: ListTile(
                  leading: const TintedIcon(
                    icon: Icons.logout_rounded,
                    color: RhythmaColors.coral,
