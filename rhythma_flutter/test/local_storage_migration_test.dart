...
void main() {
  ...
  test('Migration transparently encrypts unencrypted data', () async {
    ...
    await unencryptedCycleBox
        .put('2025-10-01', {'start_date': '2025-10-01', 'flow': 'heavy'});
    ...
    expect(keyString, isNotNull,
        reason: 'Encryption key should have been generated');
    ...
    try {
      ...
      fail(
          'Expected Hive to throw an error when opening an encrypted box without a cipher');
    } catch (e) {
      expect(e, isNotNull);
    }
  });
